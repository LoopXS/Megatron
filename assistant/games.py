"""
• `{i}akinator` | `/akinator`
   Start akinator game from Assistant
...
@ultroid_cmd(
    pattern="cancel", admins_only=True, type=["official", "manager"], func=lambda x: TRIVIA_CHATS.get(x.chat_id) 
)
